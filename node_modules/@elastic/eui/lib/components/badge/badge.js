...
var EuiBadge = function EuiBadge(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutProperties(_ref, ['children', 'color', 'iconType', 'iconSide', 'className', 'onClick', 'iconOnClick']);
  ...
  if (iconType) {
    if (iconOnClick) {
      optionalIcon = _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_icon.EuiIcon, { onClick: iconOnClick, type: iconType, size: 's', className: 'euiBadge__icon' })
      );
    } else {
