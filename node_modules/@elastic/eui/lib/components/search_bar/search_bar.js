...
var resolveQuery = function resolveQuery(query) {
  if (!query) {
    return _query.Query.parse('');
  }
  return (0, _predicate.isString)(query) ? _query.Query.parse(query) : query;
};
...
var EuiSearchBar = exports.EuiSearchBar = function (_Component) {
  ...
  function EuiSearchBar(props) {
    ...
    var query = resolveQuery(props.defaultQuery || props.query);
    _this.state = {
      query: query,
  ...
  _createClass(EuiSearchBar, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.query) {
        var query = resolveQuery(nextProps.query);
        this.setState({
          query: query,
          queryText: query.text,
          error: null
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onSearch = function (queryText) {
    try {
      var query = _query.Query.parse(queryText);
